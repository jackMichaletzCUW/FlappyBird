...
public class Pipes 
{
	...
	public static void updateGFX()
	{
		...
		//gb.fillRect(0, 0, FlappyBird.width, FlappyBird.height);
		//gb.setColor(Color.RED);
		// draw top half of left pipe
		/*gb.fillRect((int)((FlappyBird.width / 100) * Pipes.getLeftPipePosition()), 0, Pipes.PIPE_WIDTH, (int)((FlappyBird.height / 100) * Pipes.getLeftPipeTopSize()));
		// draw bottom half of left pipe
		gb.fillRect((int)((FlappyBird.width / 100) * Pipes.getLeftPipePosition()), (int)((FlappyBird.height / 100) * (Pipes.getLeftPipeTopSize() + Pipes.getLeftPipeGap())), Pipes.PIPE_WIDTH, (int)((FlappyBird.height / 100) * Pipes.getLeftPipeBottomSize()));
		
		// draw top half of right pipe
		gb.fillRect((int)((FlappyBird.width / 100) * Pipes.getRightPipePosition()), 0, Pipes.PIPE_WIDTH, (int)((FlappyBird.height / 100) * Pipes.getRightPipeTopSize()));
		// draw bottom half of right pipe
		gb.fillRect((int)((FlappyBird.width / 100) * Pipes.getRightPipePosition()), (int)((FlappyBird.height / 100) * (Pipes.getRightPipeTopSize() + Pipes.getRightPipeGap())), Pipes.PIPE_WIDTH, (int)((FlappyBird.height / 100) * Pipes.getRightPipeBottomSize()));*/
